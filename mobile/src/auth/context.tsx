...
interface AuthState {
  ...
  user: User | null;
  /** True until the initial session has been resolved from secure storage. */
  loading: boolean;
...
/**
 * Provides the auth session to the tree and keeps it in sync with Supabase Auth.
 * Wraps the app at the router root (`app/_layout.tsx`).
 */
