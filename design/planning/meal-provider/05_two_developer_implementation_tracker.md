...
### MP-A-012E — Menu structural-edit guard (ADR-7 enforcement) — `READY` (ADR-7 #30 decided = REVISION)
...
### MP-A-121 — Menu authoring/publish service + APIs — `PARTIAL` (publish writer shipped; edit/revision path remains)
...
- **Remaining (now unblocked by ADR-7 #30 = REVISION):** the **edit/revision path** — MP-A-012E structural-edit guard + the revision rebuild (rev N+1, response carry-forward, selective invalidation, re-confirm notification) + the builder's create-tree authoring RPC consumed by MP-B-030/MP-C-030. Tracked under #22 (stays in Doing) + siblings #31/#36/#37.
